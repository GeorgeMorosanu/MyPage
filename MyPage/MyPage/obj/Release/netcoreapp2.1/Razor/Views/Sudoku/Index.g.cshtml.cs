#pragma checksum "E:\Projects\MyPage\MyPage\MyPage\Views\Sudoku\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a200b9fb363f1e7b0b13e7e7cb47da72a44ec098"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a200b9fb363f1e7b0b13e7e7cb47da72a44ec098", @"/Views/Sudoku/Index.cshtml")]
...
#line hidden
        ...
        <div class=""row"">
                                ...
                                <div class=""modal-dialog"">
                                    ...
                                    <div class=""modal-content fontSize18"">
                                        <div class=""modal-header"">
                                            ...
                                            <p class=""modal-title text-center""><b><i>Sudoku: Rules</i></b>");
            WriteLiteral(@"</p>
                                        </div>
                                        <div class=""modal-body"">
                                            ...
                                            <p>
                                                Furthermore, I have included an option whe");
            WriteLiteral(@"re you can see the <b><i>Possibilities</i></b> for a chosen spot in your Puzzle.
                                            ...
                                            <br />
                                            <p>The initial given numbers will look like this: ");
            WriteLiteral(@"<span class=""given fontSize20"">1</span>, <span class=""given fontSize20"">2</span>, <span class=""given fontSize20 fontSize20"">3</span>, ... and their background will be gray.</p>
            ...
            <div class=""col-lg-2 col-md-12 padding-left-rig");
            ...
            <div class=""col-xs-12 col-lg-8"">
                <div class=""padding-left-right-increased"">
                    <div class=""row text-center"">
                        ...
                        <div class=""col-xs-4"">
                 ");
            WriteLiteral(@"           <button id=""easyMode"" type=""button"" class=""btn btn-outline-success"">Easy</button>
                        </div>
                        <div class=""col-xs-4"">
                    ...
                    <div class=""row text-center padding-top-increased"">
                        ...
                        <div class=""col-xs-6"">
                            <button id=""solve"" type=""button"" clas");
            WriteLiteral(@"s=""btn btn-outline-dark"" onclick=""printSolution();"">Solve</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    var showPossibilities = 1;
    var SudokuSolution = [];
    var generalBreak = 0;
    var lastPossition = "" "";

    function changePossibilityVisibility() {
        if (/*document.getElementById(""Possibilities"").classList.contains(""invisible"") == true*/this.showPossibilities == 1) {
            this.showPossibilities = 0;
            //document.getElementById(""Possibilities"").classList.remove(""invisible"");
        }
        else {
            this.showPossibilities = 1;
    ...
    ");
            WriteLiteral(@"        for (var i = 0; i < 9; i++) {
                ...
                for (var j = 0; j < 9; j++) {
                    ...
                    while (ok == 0) {
                        ...
                        var randomPosition = get");
            WriteLiteral(@"RandomElement(possibleElements.length);
     ...
     ");
            ...
            for (var i = 0; i < 8; i++) {
                for (var j = i + 1; j < 9; j++) {
                    if (i != j &&
                     ...
                     ");
            WriteLiteral(@"   if (myList[i] == myList[j]) {
        ...
        function getListOfAvailableOptions(x, y) {
            ...
            for (var i = 0; i < 9; i++) {
        ");
            WriteLiteral(@"        if (this.SudokuSolution[i][y] != 0) {
    ...
    ");
            WriteLiteral(@"    function createSolution() {
            //initializing with 0;
            for (var i = 0; i < 9; i++) {
        ...
        function printSudoku() {
            ...
            for (var i = 0; i < 9; i++) {
                ...
                for (var j = 0; j < 9; j++) {
                    if (t");
            WriteLiteral(@"his.SudokuPuzzle[i][j] != 0) {
                        text = text + ""<td><input id=\""lc"" + i + j + ""\"" maxlength=\""1\"" class=\""input-normal given\"" type=\""text\"" value=\"""" + this.SudokuPuzzle[i][j] + ""\"" disabled></td>"";
                    }
                    else {
                        text = text + ""<td><input id=\""lc"" + i + j + ""\"" maxlength=\""1\"" class=\""input-normal\"" type=\""text\"" value=\""\"" onChange=\""updateSudoku()\"" onClick=\""highlightPossibilities()\"" onfocus=\""blurInput();\""></td>"";
                    }
        ...
        function easyModeOn() {
            ...
            doc");
            WriteLiteral(@"ument.getElementById(""Type"").innerHTML = ""Type: Easy"";
            this.mistakes = 0;
            this.hints = 3;
...
");
    ...
    function updateSudoku() {
        ...
        if (target.value < '1' || target.value > '9') {
            ...
            var checkThisPosition = checkPositionInMyAttempt(parseInt(ta");
            WriteLiteral(@"rget.id[2]), parseInt(target.id[3]));
    ...
    function useHint() {
        ...
        if (this.hints > 0) {
            ...
            var helped = 0;
                if (this.lastPossition != "" "" &&
                    th");
            WriteLiteral(@"is.SudokuPuzzle[this.lastPossition[2]][this.lastPossition[3]] != this.SudokuSolution[this.lastPossition[2]][this.lastPossition[3]]) {
            ...
            while (helped == 0) {
                ...
                if (helped == 0) {
                    ...
                    if (this.SudokuPuzzle[randI][randJ] != this.SudokuSolution[randI][randJ]) {
                        this.");
            WriteLiteral(@"SudokuPuzzle[randI][randJ] = this.SudokuSolution[randI][randJ];
    ...
    function checkLineInMyAttempt(x) {
        ...
        for (var i = 0; i < 9; i++) {
       ");
            WriteLiteral(@"     myList.push(this.SudokuPuzzle[x][i]);
        }
        return !checkDuplicatesInList(myList);
    }
  ...
  ");
    ...
    function HighlightTargetedZone(x, y) {
        ...
        for (var i = 0; i < 9; i++) {
            document.getElementById(""lc"" + i + y).classList.ad");
            WriteLiteral(@"d(""highlightZone"");
        }
    ...
    function blurInput(){
        if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
            document.getElementById(event.target.id).blu");
            WriteLiteral("r();\r\n        }\r\n    }\r\n\r\n</script>\r\n");
            EndContext();
        }
