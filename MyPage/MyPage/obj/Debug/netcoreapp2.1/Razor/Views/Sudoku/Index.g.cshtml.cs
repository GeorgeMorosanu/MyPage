#pragma checksum "E:\Projects\MyPage\MyPage\MyPage\Views\Sudoku\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5445583934a3153e001fdbfec1718edad4c1e3b3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5445583934a3153e001fdbfec1718edad4c1e3b3", @"/Views/Sudoku/Index.cshtml")]
...
<script>
        ...
        for (var i = 0; i < 9; i++) {
            ...
            for (var j = 0; j < 9; j++) {
                ...
                while (ok == 0) {
                    ...
                    // To many failed attempts leads to ");
            WriteLiteral(@"remaking the line
                    if (noAttepts > 50) {
                        removeLine(i);
                        i--;
                        break;
    ...
    function getRandomElement(maxindex) {
        retur");
            WriteLiteral(@"n Math.floor((Math.random() * 100) % maxindex);
    }
 ...
 ");
  ...
  ");
    ...
    //Generating the current Sud");
            WriteLiteral(@"oku [the displayed puzzle]
    generateSudoku();
    ...
    function updateSudoku() {
        ...
        if (target.value < '1' || target.value > '9') {
            ...
            if (checkThisPosition == 2) {
                // Great! Th");
            WriteLiteral(@"e correct solution
                ...
                document.getElementById(target.id).classList.remove(""good"");
                doc");
            WriteLiteral(@"ument.getElementById(target.id).classList.remove(""great"");
    ...
    function highlightPossibilities() {
        ...
        HighlightTargetedZone(li");
            WriteLiteral(@"ne, column);
  ...
  ");
        ...
        for (var i = 0; i < 9; i++) {
      ");
            WriteLiteral(@"      if (this.SudokuPuzzle[x][i] != 0) {
