#pragma checksum "E:\Projects\MyPage\MyPage\MyPage\Views\Sudoku\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2a9da3171fe7fd661b0f1f22c0726f905127d025"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2a9da3171fe7fd661b0f1f22c0726f905127d025", @"/Views/Sudoku/Index.cshtml")]
        ...
        function generateSolution() {
            ...
            WriteLiteral(@"for (var j = 0; j < 9; j++) {
                    ...
                    while (ok == 0) {
                        ...
                        this.SudokuSolution[i][j] = possibl");
            WriteLiteral(@"eChoice;
...
");
        ...
        function getListOfAvailableOptions(x, y) {
            ...
            for (var i = 0; i < 9; i++) {
                if (this.SudokuSolution[i][y] != 0) {
                    ...
                    if (index > -1) {
            ");
            WriteLiteral(@"            returnedList.splice(index, 1);
                    }
                }
            }
            return returnedList;
            ...
            for (var i = 0; i < 9; i++) {
                ...
                for (var j = 0; j < 9; j++) {
                    if (this.SudokuPuzzle[i][j] != 0) {
                        text = text + ""<td><input id=\""lc"" + i + j + ""\"" maxlength=\""1\"" class=\""input-normal given\"" type=\""text\"" value=\"""" + this");
            WriteLiteral(@".SudokuPuzzle[i][j] + ""\"" disabled></td>"";
                    }
                    else {
        ...
        document.getElementById(");
            WriteLiteral(@"""easyMode"").addEventListener(""click"", function () {
            easyModeOn();
        });
  ...
  ");
        ...
        function remakeSudoku() {
            ...
            document.getElementById(""Type"").innerH");
            WriteLiteral(@"TML = ""Type: Medium"";
    ...
    ");
       ...
       ");
            WriteLiteral(@"         
                ...
                document.getElementById(target.id).classList.remove(""great"");
        ");
            WriteLiteral(@"        document.getElementById(target.id).classList.add(""wrong"");
        ...
        if (this.hints > 0) {
            ...
            var helped = 0;
                if (this.lastPossition != "" "" &&
                    ...
                    this.SudokuPuzzle[this.");
            WriteLiteral(@"lastPossition[2]][this.lastPossition[3]] = this.SudokuSolution[this.lastPossition[2]][this.lastPossition[3]];
   ...
   ");
            WriteLiteral(@"                     this.chosenTarget = document.getElementById(""lc"" + randI + randJ);
...
");
    ...
    function checkIfItIsDone() {
         ...
         if (this.SudokuSolved == 1) {
            ...
            document.getElementById(""TimeWatch"").innerHTML = ""TimeWatch: "" ");
            WriteLiteral(@"+ timeFormat(seconds);
            this.SudokuSolved = 2;
        }
