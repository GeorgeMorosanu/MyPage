#pragma checksum "E:\Projects\MyPage\MyPage\MyPage\Views\Sudoku\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6edb7d99087548679eff58331d97a3670579dfe4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6edb7d99087548679eff58331d97a3670579dfe4", @"/Views/Sudoku/Index.cshtml")]
...
#line hidden
        ...
        <div class=""row"">
            ...
            <div class=""col-lg-2 col-md-12 col-xs-12 padding-left-right-none"">
            ...
            <div class=""col-md-12 col-lg-10"">
                <div class=""padding-left-right-increased"">
                    <div class=""row text-center"">
                        ...
                        <div class=""centered-button col-xs-12 col-lg-12"">
                ");
            WriteLiteral(@"            <button id=""mediumMode"" type=""button"" class=""btn btn-outline-warning"">Medium</button>
                        </div>

                        <div class=""centered-button col-xs-6 col-lg-6"">
                    ...
                    <div class=""row text-center padding-top-increased"">
                        ...
                        <d");
            WriteLiteral(@"iv class=""col-xs-6"">
...
<script>
    ...
    function changePossibilityVisibility() {
        ...
        function generateSolution() {
            ");
            WriteLiteral(@"this.generalBreak = 0;
 ...
 ");
       ...
       ");
            WriteLiteral(@" function checkPosition(i, j) {
            if (checkLine(i) == 1 &&
                checkColumn(j) == 1 &&
                checkRegion(i, j) == 1)
                return 1;
...
");
        ...
        function printSolution() {
            ...
            text = text + ""</table>"";
            document.getElementById(""Sudok");
            WriteLiteral(@"u"").innerHTML = text;
            this.SudokuSolved = 1;
        }
...
");
    ...
    function placePossibility() {
        ...
        if (this.lastPossition != "" "") {
            ...
            //consol");
            WriteLiteral(@"e.log(this.chosenTarget);
            updateSudoku();
        }
        ...
        if (this.hints > 0) {
            ...
            while (helped == 0) {
                ...
                if (helped == 0) {
                    ...
                    if (this.SudokuPuzzle[randI][r");
            WriteLiteral(@"andJ] != this.SudokuSolution[randI][randJ]) {
                        this.SudokuPuzzle[randI][randJ] = this.SudokuSolution[randI][randJ];
...
");
    ...
    function print");
            WriteLiteral(@"Possibilities(possibleElements) {
        var text = """";
        var k = 0;
        for (var i = 1; i <= 9; i++) {
    ...
    function Highli");
            WriteLiteral(@"ghtTargetedZone(x, y) {
    ...
    function blurInput(){
        if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(naviga");
